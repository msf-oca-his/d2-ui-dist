...
var _Validators = require('../forms/Validators');
...
var formFieldsConfigs = [{
    ...
    validators: [{
        validator: _Validators.isRequired,
        message: _Validators.isRequired.message
    }]
}, {
    name: 'startValue',
    component: _TextField2.default,
    ...
    name: 'color',
    component: (0, _mapProps2.default)(function (props) {
        return {
            color: props.value,
